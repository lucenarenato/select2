    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            ...
            <% }); %>
                ...
                <fieldset><div class="form-group">
                    <label for="dados[cpf_motorista]" class="col-sm-3 control-label">CPF</label>
                ...
                <fieldset class="if-cnpj"><div class="form-group">
                    <label for="razao_motorista" class="col-sm-3 control-label">Razão Social</label>
                    <div class="col-sm-3"><input id="razao_motorista" name="dados[razao_motorista]" class="form-control" type="text" value="<%= view.attributes.razao_motorista %>">
                    </div>
                    <label for="cnpj_motorista" class="col-sm-3 control-label">CNPJ</label>
                    <div class="col-sm-3"><input id="cnpj_motorista" name="dados[cnpj_motorista]" class="form-control" type="text" value="<%= view.attributes.cnpj_motorista %>">
                    </div>
                </div></fieldset>
<fieldset>
    <div class="form-group">
...
<div class="modal-content">
  <div class="modal-header">
    ...
    <h4 class="modal-title" id="plantasResumidasLabel">Plantas para origem</h4>
  </div>
...
<input name="dados[posicao]" value="1" type="hidden">`,
  {"variable": "view"}),
  "initialize": function () {
    try {
      this.release();
