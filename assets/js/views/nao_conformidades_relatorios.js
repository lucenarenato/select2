{
	"tagName": "div",
	"id": "adagio-home",
	"className": "adagio-nao-conformidades-relatorios",
	"events": {
		"submit": "report",
	},
...
<a href="#!/naoConformidades/relatorios/0/edit" class="list-group-item">Leading Indicators</a>
</div>
			</div><!-- /.col-md-4 -->
			<div class="col-md-8">
			</div><!-- /.col-md-8 -->
	...
	"render": function () {
		if (true) {
			...
			adagio.eventBus.trigger("navigate", '!' + adagio.environment.getTenancy('naoConformidadesRelatorios/0/edit'), {"trigger": true});
		}
